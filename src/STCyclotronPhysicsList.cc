  ...
  : G4VModularPhysicsList()
{
  ...
  G4NuclideTable::GetInstance()->SetLevelTolerance(0.10*eV);
...
fEmName = G4String("emstandard");
 ...
 fHadElPhysicsList = new G4HadronElasticPhysics(0);
  //fHadElPhysicsList->ConstructProcess(HadElPhysicsList);
   //RegisterPhysics( new G4HadronElasticPhysicsXS(0));
   
  //Hadron inelastic physics
  fHadPhysicsList = new G4HadronPhysicsQGSP_BIC_HP(0);
  //fHadPhysicsList = new G4HadronPhysicsQGSP_BIC(0);
  //fHadPhysicsList = new G4HadronPhysicsQGSP_BERT(0);
 //fHadPhysicsList = new G4HadronInelasticQBBC(0);
//fHadPhysicsList = new G4HadronPhysicsFTFP_BERT(0);
...
void STCyclotronPhysicsList::ConstructProcess()
{
  ...
  fThickness_foil = 0.00025*mm;
  fThickness_target = 1.23*cm;
