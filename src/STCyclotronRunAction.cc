...
{ 
  ...
  analysisManager->CreateH1("H10","Energy of the primary particles when reaching the target (MeV)", 500,8.5,9.5); //in MeV
  ...
  analysisManager->CreateH1("Electromagnetic", "Electromagnetic Processes", 100, 0., 100.);
    analysisManager->CreateH1("Decay", "Decay Processes", 100, 0., 100.);
   analysisManager->CreateH1("Hadronic", "Hadronic Processes", 100, 0., 100.);
   analysisManager->CreateH1("Processes", "Count of Different Processes", 3, 0., 3.);
    analysisManager->CreateH1("Range", "Range of primary protons", 1000, 160.5, 160.75);
  ...
  analysisManager->CreateH2("H23", "Energy (MeV) = f(depth (mm))", 200, fIn, fOut,200,0.,16.);
